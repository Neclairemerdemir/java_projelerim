# ☕ Java Programlama Temelleri ve Algoritma Çalışmaları

Bu depo, Bilgisayar Mühendisliği eğitimim süresince Java dilinin temel yapı taşlarını, algoritma mantığını ve nesne yönelimli programlama (OOP) kavramlarını pekiştirmek amacıyla geliştirdiğim küçük çaplı projeleri içermektedir.
...
* **Vücut Kitle İndeksi Hesaplama (`BoyKutleEndeksi.java`):** Kullanıcı verilerini alarak temel matematiksel formüllerle sağlık analizi yapan bir araç.
...
## 💻 Çalıştırma
Projeleri yerel makinenizde çalıştırmak için Java JDK'nın yüklü olması yeterlidir:

1. Depoyu indirin veya klonlayın.
2. Terminal üzerinden ilgili dosyanın bulunduğu dizine gidin.
